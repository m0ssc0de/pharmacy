                ...
                <div class="uk-section">
                    <div class="uk-container uk-container-small">
                            ...
                            <div class="uk-grid uk-child-width-1-1">
                                <div>
                                    <div class="uk-grid uk-child-width-1-2">
                                        <label class="uk-text-large">{"test1"}</label>
                                        <input class="uk-input uk-width-1-2" type="text" placeholder="as;ldkf;lk" />
                                    </div>
                                </div>
                                <div>
                                    <div class="uk-grid uk-child-width-1-2">
                                        <label class="uk-text-large">{"test2"}</label>
                                        <input class="uk-input uk-width-1-2" type="text" placeholder="as;ldkf;lk" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="uk-card uk-card-default uk-card-hover uk-card-body uk-height-max-large">
                            ...
                            <button class="uk-button uk-button-primary" onclick=self.link.callback(|_| Msg::CreatOne)>{ "+1" }</button>
                        </div>
                    </div>
                </div>
            </div>
